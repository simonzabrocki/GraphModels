...
graph_nodes = [
    ...
    {'type': 'variable',  # Type of node (input, output, variable, parameter)
     ...
     'in': ['FDi_an', 'AYi2017'],  # Specify what comes into the node
     'computation': {'name': '(FDi_an*1000000)/AYi2017',  # When the node is compulationnal specify the computation like this
                     'formula': lambda X: (X['FDi_an']*1000000)/X['AYi2017'][:6]}  # For now leave the formula field empty
    ...
    # CRfd is calculated with model data from 2017 & assumed constant for simulated years (for now)
    ...
    {'type': 'variable',  # Type of node (input, output, variable, parameter)
     ...
     'in': ['FCRi', 'AYi2017', 'ANPi'],  # Specify what comes into the node
     'computation': {'name': '(FRCi*AYi2017*ANPi)/1000000',  # When the node is compulationnal specify the computation like this
                     'formula': lambda X: (X['FCRi'][0:6] * X['AYi2017'][0:6] * X['ANPi']) / 1000000}  # For now leave the formula field empty
     },
    {'type': 'input',  # Type of node (input, output, variable, parameter)
     'unit': 'kg/animal',  # Unit
    ...
    {'type': 'parameter',  # Type of node (input, output, variable, parameter)
     ...
     'name': 'feed conversion ratio ',  # Full name
     },
